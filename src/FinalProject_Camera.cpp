...
void imageLoop(string detectorType, string descriptorType, string matcherType, ofstream& csv)
{

    /* INIT VARIABLES AND DATA STRUCTURES */
    // data location
    string dataPath = "../";
    //dataPath = "./"; // for debugging in VSCode
    // camera
    ...
    for (size_t imgIndex = 0; imgIndex <= imgEndIndex - imgStartIndex; imgIndex+=imgStepWidth)
    {
        ...
        cout << "#2 dectect & classify objects" << endl;
        ...
        for (string descriptorType: descriptorTypes)
        {
            for (string matcherType: matcherTypes)
            {
                try
                {
                    ...
                    cout << "==== detector: " << detectorType << ", descriptor: " << descriptorType << ", matcher: " << matcherType << " ====" << endl;
                    imageLoop(detectorType, descriptorType, matcherType, csvStream);
                }
                catch (cv::Exception& e) {
                    cout << "WARNING: (" << detectorType << ", " << descriptorType << ", " << matcherType << ") are incompatible" << endl;
                    continue;
                }
            }
        }
